...
(function () {
  ...
  /* ── NAV LINK HELPER ─────────────────────────────────────── */
  var navLinkCls = 'dcb-nav-link font-headline font-bold text-[0.9375rem] tracking-[-0.02em] text-[#0B3D91] no-underline flex items-center py-2 px-3 rounded-lg transition-colors duration-150 group-hover:text-[#F57C00]';
  ...
  var footer =
    '<footer id="dcb-footer-desktop" class="bg-[#072B6B] text-white pt-20 pb-10">' +
      '<div class="max-w-[80rem] mx-auto px-6">' +
        ...
        '<div class="border-t border-white/10 pt-8 pb-8 mb-2">' +
          ...
          '<dl class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-10 m-0">' +
            ...
            '<div>' +
              ...
              '<dd class="m-0 pl-6">' +
                ...
                '</ul>' +
                '<ul class="list-none p-0 mt-4 pt-4 border-t border-white/10 space-y-1.5">' +
        ...
        '<!-- Bottom bar -->' +
        '<div class="border-t border-white/10 pt-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 flex-wrap">' +
